...
const Account = () => {
    ...
    useEffect(() => {
        const getuserinfo = async () => {
            const response = await fetch('presidential-dina-critic-coder-bcfa82d2.koyeb.app/userinfo/g', {
                method: 'POST',
                headers: {
            ...
            const userResponse = await fetch('presidential-dina-critic-coder-bcfa82d2.koyeb.app/getuser', {
                method: 'POST',
                headers: {
                    'authToken': authToken
                }
    ...
    const helpSubmit = async (e) => {
        e.preventDefault()
        const response = await fetch('presidential-dina-critic-coder-bcfa82d2.koyeb.app/help', {
            method: 'POST',
    ...
    const profileSubmition = async () => {
        const response = await fetch('presidential-dina-critic-coder-bcfa82d2.koyeb.app/userinfo/p', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const settingsSubmition = async (name) => {
        const response = await fetch('presidential-dina-critic-coder-bcfa82d2.koyeb.app/userinfo/sp', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
