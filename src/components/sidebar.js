...
const Sidebar = () => {
   ...
   const fetchCourses = () => {
      fetch('presidential-dina-critic-coder-bcfa82d2.koyeb.app/')
   ...
   const fetchsavedCourses = async () => {
      try {
         const response = await fetch('presidential-dina-critic-coder-bcfa82d2.koyeb.app/getuser/savedcourses', {
            method: 'POST',
            headers: {
