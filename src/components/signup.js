...
const Signup = () => {
    ...
    const submission = async (e) => {
        ...
        const response = await fetch('presidential-dina-critic-coder-bcfa82d2.koyeb.app/signup', {
            method: 'POST',
    ...
    const savepass = async (user) => {
        const response = await fetch('presidential-dina-critic-coder-bcfa82d2.koyeb.app/userpass', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                userid: user._id,
    ...
    const userInfoSubmission = async (user) => {
        const response = await fetch('presidential-dina-critic-coder-bcfa82d2.koyeb.app/signupinfo', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                userid: user._id,
